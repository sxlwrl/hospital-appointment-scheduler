...
describe('AppointmentController', () => {
  ...
  describe('Create', () => {
    it('Should create a new appointment if validation passes', async () => {
      ...
      (service.createAppointment as jest.Mock).mockResolvedValue(
        createdAppointment,
      );
    ...
    it('Should return 400 if validation fails', async () => {
      ...
      const validationErrors = [
        {
          property: 'patient_id',
          constraints: { isNumber: 'Patient ID should a number' },
        },
      ];
  ...
  describe('Update', () => {
    it('Should update an appointment if validation passes', async () => {
      ...
      (validate as jest.Mock).mockResolvedValue([]);
      (service.updateAppointment as jest.Mock).mockResolvedValue(
        updatedAppointment,
      );
