...
describe('AvailController', () => {
    ...
    describe('GetById', () => {
        it('Should return availability if it is found', async () => {
            ...
            const availability = { id: 1, doctor_id: 1, available_date: '2024-09-08', available_time: '14:30:00', duration: 30};
    ...
    describe('GetAll', () => {
        it('Should return all availabilities', async () => {
            ...
            const availabilities = [
                { id: 1, doctor_id: 1, available_date: '2024-09-08', available_time: '14:30:00', duration: 30},
                { id: 2, doctor_id: 1, available_date: '2024-09-08', available_time: '15:30:00', duration: 25},
            ];
    ...
    describe('Create', () => {
        it('Should create availability if validation passes', async () => {
            const req = mockRequest({ body: { doctor_id: 1, available_date: '2024-09-08', available_time: '14:30:00', duration: 30 } });
            const res = mockResponse();

            const createDto = new CreateAvailDto(req.body);
            const createdAvailability = { id: 1, doctor_id: 1, available_date: '2024-09-08', available_time: '14:30:00', duration: 30};
        ...
        it('Should return 400 if validation fails', async () => {
            ...
            const validationErrors = [
                {
                    property: 'doctor_id',
                    constraints: { isNotEmpty: 'Date should not be empty', isNumber: 'ID should be a number' },
                },
            ];
    ...
    describe('Update', () => {
        it('Should update availability if validation passes', async () => {
            ...
            const updatedAvailability = { id: 1, doctor_id: 1, available_date: '2024-09-08', available_time: '15:00:00', duration: 30 };
        ...
        it('Should return 400 if validation fails', async () => {
            const req = mockRequest({ params: { id: '1' }, body: { duration: '40' } });
            const res = mockResponse();
        ...
        it('Should handle errors', async () => {
            const req = mockRequest({
                params: { id: '1' },
                body: { doctor_id: 1, available_date: '2024-09-08', available_time: '15:00:00', duration: 30 },
            });
            const res = mockResponse();
