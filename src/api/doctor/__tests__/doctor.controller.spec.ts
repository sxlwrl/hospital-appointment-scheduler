...
describe('DoctorController', () => {
    ...
    describe('GetById', () => {
        it('Should return doctor if it is found', async () => {
            ...
            const doctor = { id: 1, first_name: 'Smith', last_name: 'Watson', specialization_id: 1 };
    ...
    describe('GetAll', () => {
        it('Should return all doctors', async () => {
            ...
            const doctors = [
                { id: 1, first_name: 'Smith', last_name: 'Watson', specialization_id: 1 },
                { id: 2, first_name: 'Alex', last_name: 'Nowman', specialization_id: 1 },
            ];
    ...
    describe('Create', () => {
        it('Should create a doctor if validation passes', async () => {
            const req = mockRequest({ body: { first_name: 'Smith', last_name: 'Watson', specialization_id: 1 } });
            const res = mockResponse();

            const createDto = new CreateDoctorDto(req.body);
            const createdDoctor = { id: 1, first_name: 'Smith', last_name: 'Watson', specialization_id: 1 };
        ...
        it('Should return 400 if validation fails', async () => {
            const req = mockRequest({ body: { first_name: '', last_name: 'Watson', specialization_id: 1 } });
            const res = mockResponse();
    ...
    describe('Update', () => {
        it('Should update a doctor if validation passes', async () => {
            const req = mockRequest({
                params: { id: '1' },
                body: { first_name: 'Smith', last_name: 'Watson', specialization_id: 1 },
            });
            const res = mockResponse();

            const updateDto = new UpdateDoctorDto(req.body);
            const updatedDoctor = { id: 1, first_name: 'Smith', last_name: 'Watson', specialization_id: 1 };
        ...
        it('Should return 400 if validation fails', async () => {
            const req = mockRequest({ params: { id: '1' }, body: { first_name: '' } });
            const res = mockResponse();
