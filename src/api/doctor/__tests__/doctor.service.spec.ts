...
describe('DoctorService', () => {
    ...
    beforeEach(() => {
        service = new DoctorService(mockDoctorRepository, mockSpecializationRepository);
    });
    ...
    describe('FindById', () => {
        it('Should return a doctor if found', async () => {
            ...
            (mockDoctorRepository.findById as jest.Mock).mockResolvedValueOnce(doctor);
    ...
    describe('FindAll', () => {
        it('Should return all doctors', async () => {
            ...
            (mockDoctorRepository.findAll as jest.Mock).mockResolvedValueOnce(doctors);
    ...
    describe('CreateDoctor', () => {
        it('Should create a new doctor if specialization exists', async () => {
            const createDto: CreateDoctorDto = { firstName: 'Smith', lastName: 'Watson', specialization_id: 1 };
            const doctor = new Doctor(1, 'Smith', 'Watson', 1);
            const specialization = new Specialization(1, 'Surgery');

            (mockSpecializationRepository.findById as jest.Mock).mockResolvedValueOnce(specialization);
        ...
        it('Should throw NotFoundError if specialization does not exist', async () => {
            const createDto: CreateDoctorDto = { firstName: 'Smith', lastName: 'Watson', specialization_id: 2 };

            (mockSpecializationRepository.findById as jest.Mock).mockResolvedValueOnce(null);

            await expect(service.createDoctor(createDto)).rejects.toThrow(NotFoundError);
    ...
    describe('UpdateDoctor', () => {
        it('Should update and return the doctor if it and its specialization exist', async () => {
            const updateDto: UpdateDoctorDto = { firstName: 'Smith', lastName: 'Watson', specialization_id: 3 };
        ...
        it('Should throw NotFoundError if doctor does not exist', async () => {
            ...
            await expect(service.updateDoctor(1, updateDto)).rejects.toThrow(NotFoundError);
            expect(mockDoctorRepository.findById).toHaveBeenCalledWith(1);
        });
    ...
    describe('deleteDoctor', () => {
        it('Should delete the doctor if it exists', async () => {
            ...
            (mockDoctorRepository.findById as jest.Mock).mockResolvedValueOnce(doctor);
            (mockDoctorRepository.delete as jest.Mock).mockResolvedValueOnce(undefined);
